...
public class MelodyRenderPipelineAsset : RenderPipelineAsset {
    ...
    [SerializeField]
    CameraBufferSettings cameraBufferSettings = new CameraBufferSettings { allowHDR = true, renderScale = 1.0f, useDepthNormal = true, useDiffuse = true, useSpecular = true,
