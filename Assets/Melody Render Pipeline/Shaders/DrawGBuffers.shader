Shader "Hidden/DrawGBuffers" {
    ...
    SubShader {
        ...
        void frag(v2f i, 
                  out fixed4 GT0 : SV_TARGET0,
                  out fixed4 GT1 : SV_TARGET1,
                  out fixed4 GT2 : SV_TARGET2)
        {
            ...
            GT0 = fixed4(diffuse, occlusion);
            GT1 = fixed4(specular, smoothness);
            GT2 = EncodeDepthNormal(i.nz.w, normal);
        }
