...
namespace Crest.EditorHelpers
{
    ...
    public static class EditorHelpers
    {
        ...
        public static Camera GetActiveSceneViewCamera()
        {
            ...
            if (EditorWindow.focusedWindow != null && (EditorWindow.focusedWindow.titleContent.text == "Scene" || EditorWindow.focusedWindow.titleContent.text == "Game"))
            {
        ...
        public static GameObject GetGameObject(SerializedObject serializedObject)
        {
            ...
            return serializedObject.targetObject is GameObject ? serializedObject.targetObject as GameObject : (serializedObject.targetObject as Component).gameObject;
        }
    }
}
